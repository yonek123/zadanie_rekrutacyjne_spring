INSERT IGNORE INTO USERS (USERID, USERNAME) VALUES
    (0, 'januszex'),
    (1, 'nowax'),
    (2, 'bob'),
    (3, 'fred'),
...
INSERT IGNORE INTO FACILITIES (FACILITYID, FACILITYNAME, FACILITYPRICE, FACILITYAREA, FACILITYDESCRIPTION) VALUES
...
INSERT IGNORE INTO RESERVATIONS (RESERVATIONID, RESERVATIONSTART, RESERVATIONEND, OWNERID, LESSEEID, RESERVEDFACILITYID) VALUES
